      ...
      {categoryList.map((item, idx) => (
        <li key={idx} className="py-2">
          <button
            ...
            className={`flex-shrink-0 py-2.5 px-[30px] rounded-[40px] border-light border border-solid cursor-pointer font-medium capitalize hover:bg-light hover:text-dark transition ease-in-out duration-300 focus:outline focus:outline-1 focus:outline-offset-2 focus:outline-accent ${
